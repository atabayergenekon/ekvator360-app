...
export function GlobePulse({
  ...
  useEffect(() => {
    ...
    function init() {
      ...
      width, height: width,
      phi: 0.15, theta: 0.18, dark: 1, diffuse: 1.7,
      mapSamples: 16000, mapBrightness: 10,
      baseColor: [0.54, 0.18, 0.07],
      markerColor: [1, 0.42, 0.14],
      glowColor: [0.16, 0.06, 0.03],
      markerElevation: 0,
      markers: markers.map((m) => ({ location: m.location, size: 0.025, id: m.id })),
      arcs: [], arcColor: [1, 0.48, 0.18],
      ...
      {markers.map((m) => (
        ...
        >
          <span style={{
            ...
            border: "2px solid #ff6a22", borderRadius: "50%", opacity: 0,
          ...
          <span style={{
            width: 10, height: 10, background: "#ff6a22", borderRadius: "50%",
            boxShadow: "0 0 0 3px #160806, 0 0 0 5px #ff6a22",
          }} />
        </div>
      ))}
    </div>
